...
<?php
    ...
    if (!isset($_SESSION['expireTime']) or !isset($_SESSION['username'])) {
        ...
        $query2="SELECT COUNT(*) from appointments";
        ...
        <section class="section1">
            <div class="container" id="display1" >
                <div class="listHeader">
                    <img src="images/logos_icons/notebook_icon.png" alt="notebook">
                </div>
                <div class="listBlock">
                    <?php
                    ...
                    <div class = "singleRecord" >
                        <p class="tooltip">
                            <a href="specific_task_appo_page.php?api=<?php echo $row['id']; ?>" >
                                <?php echo $row['theme']; ?> (<?php echo $row['category']; ?>)                           
                            </a> 
                ...
                <div class="listBottom">
                        <a href="appo_add.php">                
                            <button type="button" class="btn-add" style="position:relative; top:5px;">Add a New Appointment</button>
                        </a>
                </div>
            </div>
        </section>
