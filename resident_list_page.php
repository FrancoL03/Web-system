    ...
    <body>
        ...
        <section class="section1">
            <div class="container" id="display1">
                <div class="listHeader">
                    <img src="images/logos_icons/resident_icon.png" alt="notebook">
                </div>
            <div class="listBlock">
                <?php
                ...
                <div class = "singleRecord" >
                    <p class="tooltip">
                        <a href="resident_home_page.php?rty=<?php echo $row['residentName']; ?>" >
        ...
        <footer>
            <p id="footerText" style="margin-top:6px;font-weight: lighter;" >
                <a href = "personal_home_page.php"  style="font-weight:inherit; font-family:'Times New Roman'; font-size:inherit; color:inherit;">    
                    Go to The Home Page                        
                </a>  
            </p>
        </footer>
